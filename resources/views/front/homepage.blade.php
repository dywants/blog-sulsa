    ...
    <div class="wrapper">
        ...
        <div class="max-w-5xl mx-auto">
            <section id="content">
                ...
                <aside id="sidebar">
                    <div
                        class="p-4 @if(\Illuminate\Support\Facades\Route::currentRouteName() === "homepage")bg-secondary-600 @endif">
                        <div id="top-articles">
                            <h4>TOP RECETTES</h4>
                            <hr>
                            @forelse($postsFeatured as $post)
                                <div class="sidebar-article">
                                    <div>
                                        <img src="{{ asset('storage/'. $post->image) }}" class="sidebar-thumb" width="100%"
                                             height="100%" alt="">
                                    </div>
                                    <div class="sidebar-article-desc">
                                        <h5>{{ $post->title }}</h5><span
